  ...
  return (
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
          <Link href="/login" style={{
            ...
            border: '1px solid #e5e7eb', textDecoration: 'none', color: '#374151'
          }}>
            تسجيل الدخول
          </Link>
      ...
      <section style={{ textAlign: 'center', padding: '5rem 1.5rem 4rem', maxWidth: 700, margin: '0 auto' }}>
        ...
        <h1 style={{
          fontSize: 40, fontWeight: 800, lineHeight: 1.35,
        ...
        <p style={{
          fontSize: 17, color: '#6b7280', lineHeight: 1.8,
          marginBottom: 36, maxWidth: 520, margin: '0 auto 36px'
        }}>
          شواهدي تساعد مدارس التعليم العام على توثيق وتنظيم شواهد معايير الاعتماد المدرسي — مجال بمجال، مؤشراً بمؤشر، بضغطة واحدة.
        </p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/register" style={{
            padding: '14px 36px', fontSize: 16, fontWeight: 700,
            background: '#1d4ed8', color: '#fff', borderRadius: 10,
            textDecoration: 'none', boxShadow: '0 4px 14px rgba(29,78,216,0.3)'
          }}>
            سجّل مدرستك الآن ←
          </Link>
          <Link href="/login" style={{
            ...
            textDecoration: 'none', color: '#374151', background: '#fff'
          }}>
            تسجيل الدخول
          </Link>
        </div>
      ...
      <section style={{
        ...
        borderBottom: '1px solid #e5e7eb', padding: '2rem 1.5rem'
      }}>
        <p style={{
          textAlign: 'center', fontSize: 13, color: '#9ca3af',
          marginBottom: 20, fontWeight: 500, textTransform: 'uppercase', letterSpacing: 1
        }}>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={d.label} style={{
              background: d.color, borderRadius: 12, padding: '18px 10px', textAlign: 'center'
            }}>
      ...
      <section style={{ padding: '4rem 1.5rem', maxWidth: 680, margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          <p style={{ fontSize: 12, color: '#1d4ed8', fontWeight: 700, letterSpacing: 1, marginBottom: 8 }}>
            المشكلة
          </p>
          <h2 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', marginBottom: 8 }}>
            ما تواجهه المدارس اليوم
          </h2>
          <p style={{ fontSize: 15, color: '#6b7280' }}>
            معايير التقويم نظام جديد — وكثير من المدارس تبدأ من الصفر في كل زيارة
          </p>
        </div>
        <div style={{ display: 'grid', gap: 12 }}>
          {[
            {
              icon: '📂', color: '#fef2f2',
              title: 'الشواهد مبعثرة أو مفقودة',
              desc: 'الملفات الورقية تضيع، والصور غير مصنفة، والمدير لا يعرف ما اكتمل وما ينقصه قبيل الزيارة.'
            },
            {
              icon: '🤷', color: '#fffbeb',
              title: 'النظام جديد وغير مفهوم بالكامل',
              desc: 'كثير من المدارس تقدم شواهد خاطئة أو غير كافية لأنها لا تعرف ما المطلوب بالضبط لكل مؤشر.'
            },
            {
              icon: '⏰', color: '#f0f9ff',
              title: 'التجهيز يأتي متأخراً',
              desc: 'المدارس تبدأ التجهيز قبل الزيارة بأيام قليلة، مما يضغط على الإدارة ويقلل جودة الشواهد المقدمة.'
            },
          ].map(p => (
            <div key={p.title} style={{
              display: 'flex', gap: 16, padding: '1.25rem 1.5rem',
              background: p.color, borderRadius: 12, border: '1px solid #e5e7eb'
            }}>
      ...
      <section style={{ background: '#fff', borderTop: '1px solid #e5e7eb', padding: '4rem 1.5rem' }}>
        <div style={{ maxWidth: 680, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            <p style={{ fontSize: 12, color: '#16a34a', fontWeight: 700, letterSpacing: 1, marginBottom: 8 }}>
              الحل
            </p>
            <h2 style={{ fontSize: 28, fontWeight: 800, color: '#0f172a', marginBottom: 8 }}>
              شواهدي تحل المشكلة
            ...
            <p style={{ fontSize: 15, color: '#6b7280' }}>
              منصة متكاملة تقود مدير المدرسة خطوة بخطوة طوال العام
            </p>
          </div>
      ...
      <section style={{ padding: '4rem 1.5rem' }}>
        <div style={{ maxWidth: 460, margin: '0 auto', textAlign: 'center' }}>
          <div style={{
            ...
            <p style={{ fontSize: 12, color: '#1d4ed8', fontWeight: 700, letterSpacing: 1, marginBottom: 12 }}>
              سعر الاشتراك السنوي
            </p>
            <p style={{ fontSize: 52, fontWeight: 800, color: '#0f172a', margin: '0 0 4px', lineHeight: 1 }}>
              999
            </p>
            <p style={{ fontSize: 18, color: '#6b7280', marginBottom: 20 }}>ريال سعودي / سنة</p>
            <div style={{ textAlign: 'right', marginBottom: 24 }}>
              {[
                'وصول كامل لجميع المجالات والمؤشرات',
                'تخزين غير محدود للشواهد',
                'نماذج جاهزة قابلة للتخصيص',
                'تقارير PDF احترافية',
                'دعم فني مستمر',
              ].map(f => (
