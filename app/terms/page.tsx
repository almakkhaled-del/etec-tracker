      ...
      <main style={{ maxWidth: 760, margin: '0 auto', padding: '48px 20px 60px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 18, border: '1px solid rgba(11,31,58,0.07)', padding: '2rem 1.8rem', boxShadow: '0 4px 16px rgba(11,31,58,0.06)' }}>
          ...
          <Section title="٣. الباقات والاشتراكات">
            <ul>
              <li><strong>الباقة التجريبية:</strong> تجربة مجانية لمدة 7 أيام، تتيح الوصول لمجال واحد فقط من أصل المجالات الأربعة، بحد أقصى للتخزين كما هو موضح في صفحة الباقات على الموقع. لا تتطلب بطاقة ائتمان.</li>
              <li><strong>الباقة المتكاملة:</strong> اشتراك سنوي مدفوع يتيح الوصول لجميع المجالات الأربعة وكامل مزايا المنصة كما هو موضح في صفحة الباقات على الموقع. السعر المعروض وقت الاشتراك (بما في ذلك أي عروض أو خصومات مؤقتة) هو السعر المُعتمد لتلك الفترة.</li>
              <li>التجديد السنوي، وأي تعديل أو إلغاء للاشتراك، يتم عبر التواصل المباشر معنا حسب القنوات الموضحة على الموقع.</li>
              <li>نحتفظ بحق تعديل الأسعار أو مزايا أي باقة مستقبلاً، مع إخطار مستخدمينا بأي تغيير جوهري قبل تطبيقه على اشتراكات قائمة.</li>
            </ul>
          </Section>
